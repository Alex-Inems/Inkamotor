/**
 * REFERENCE ONLY — full Google Search Console implementation (paused).
 * Not imported by the app. Copy back into search-console.ts when enabling Google.
 */
...
/** Last 28 days of typically-available GSC data (Google lags ~2ΓÇô3 days). */
