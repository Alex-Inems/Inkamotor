...
export function InvoicesPanel({
    ...
    try {
      const res = await fetch("/api/invoices/send", {
        ...
        body: JSON.stringify({
          ...
          totalLabel: formatSalesMoney(invoiceTotal(preview), locale),
        }),
      });
  ...
  return (
    <>
      ...
      <Modal open={openAdd} title={t("pages.invoices.generate")} onClose={() => onOpenAddChange(false)} wide>
